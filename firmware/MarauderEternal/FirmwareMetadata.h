...
constexpr size_t METADATA_VERSION_SIZE = 16;
constexpr size_t METADATA_PARTITION_SIZE = 32;
constexpr uint8_t METADATA_SCHEMA_VERSION = 2;
...
struct __attribute__((packed)) Metadata {
  ...
  char version[METADATA_VERSION_SIZE];
  char partition_layout[METADATA_PARTITION_SIZE];
